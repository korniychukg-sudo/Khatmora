...
struct QPCardStyle: ViewModifier {
        ...
        content
            ...
            .background(
                RoundedRectangle(cornerRadius: QPTheme.corner, style: .continuous)
                    ...
                    .shadow(color: QPTheme.ink.opacity(0.06), radius: 8, x: 0, y: 3)
            )
    }
}

extension View {
    func qpCard(padding: CGFloat = 16) -> some View { modifier(QPCardStyle(padding: padding)) }
}
