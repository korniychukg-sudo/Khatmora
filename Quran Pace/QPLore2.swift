...
extension QPLore {
    ...
    private static let glossaryA: [QPTerm] = [
        QPTerm(id: "qt-mushaf", term: "Mushaf", definition: "A physical copy of the Quran; this app follows the standard 604-page Madani layout."),
        QPTerm(id: "qt-juz", term: "Juz", definition: "One of thirty near-equal parts of the Quran, about twenty pages each."),
        QPTerm(id: "qt-hizb", term: "Hizb", definition: "Half of a juz; sixty in the whole book."),
        QPTerm(id: "qt-rub", term: "Rub al-hizb", definition: "A quarter of a hizb, marked by a small ornament in most mushaf margins."),
        QPTerm(id: "qt-surah", term: "Surah", definition: "One of the 114 named compositions of the Quran."),
        QPTerm(id: "qt-ayah", term: "Ayah", definition: "A single verse; literally a sign. The standard count totals 6,236."),
        QPTerm(id: "qt-khatm", term: "Khatm", definition: "A complete reading of the Quran from beginning to end."),
        QPTerm(id: "qt-tilawah", term: "Tilawah", definition: "The act of reciting the Quran."),
        QPTerm(id: "qt-tartil", term: "Tartil", definition: "Slow, measured recitation, commanded in the Quran itself."),
        QPTerm(id: "qt-tajwid", term: "Tajwid", definition: "The science of pronouncing every letter of recitation correctly.")
    ]

    private static let glossaryB: [QPTerm] = [
        QPTerm(id: "qt-juzamma", term: "Juz Amma", definition: "The thirtieth juz, containing the short final surahs; most memorization begins here."),
        QPTerm(id: "qt-fatihah", term: "Al-Fatihah", definition: "The seven-verse opening surah, recited in every unit of the prayer."),
        QPTerm(id: "qt-makki", term: "Meccan", definition: "A surah revealed before the migration to Medina; 86 surahs are Meccan."),
        QPTerm(id: "qt-madani", term: "Medinan", definition: "A surah revealed after the migration; typically longer and legislative."),
        QPTerm(id: "qt-hafiz", term: "Hafiz", definition: "Someone who has memorized the entire Quran."),
        QPTerm(id: "qt-hifz", term: "Hifz", definition: "The discipline of memorizing the Quran."),
        QPTerm(id: "qt-qari", term: "Qari", definition: "A trained reciter of the Quran."),
        QPTerm(id: "qt-basmalah", term: "Basmalah", definition: "The formula bismillahir-rahmanir-rahim that opens every surah except At-Tawbah."),
        QPTerm(id: "qt-istiadhah", term: "Isti'adhah", definition: "Seeking refuge in Allah from Shaytan, said before beginning recitation."),
        QPTerm(id: "qt-sajdah", term: "Sajdat at-tilawah", definition: "The prostration of recitation, marked at fifteen places in the mushaf.")
    ]

    private static let glossaryC: [QPTerm] = [
        QPTerm(id: "qt-wird", term: "Wird", definition: "A fixed personal daily portion of reading or remembrance."),
        QPTerm(id: "qt-waqf", term: "Waqf", definition: "A stopping point in recitation; small letters above the text mark where pausing is preferred."),
        QPTerm(id: "qt-tarawih", term: "Tarawih", definition: "The long nightly Ramadan prayers, in which many mosques recite the whole Quran across the month."),
        QPTerm(id: "qt-madani-mushaf", term: "Madani mushaf", definition: "The most widely printed Quran edition: 604 pages, 15 lines per page."),
        QPTerm(id: "qt-riwayah", term: "Riwayah", definition: "A transmitted reading tradition of the text; Hafs from Asim is the most widespread."),
        QPTerm(id: "qt-tafsir", term: "Tafsir", definition: "Commentary and explanation of the Quran's meanings."),
        QPTerm(id: "qt-eid", term: "Eid al-Fitr", definition: "The festival that ends Ramadan — a common khatm finish line."),
        QPTerm(id: "qt-laylat", term: "Laylat al-Qadr", definition: "The Night of Decree in Ramadan, when the Quran's revelation began."),
        QPTerm(id: "qt-ajza", term: "Ajza", definition: "The plural of juz."),
        QPTerm(id: "qt-khatam", term: "Khatm du'a", definition: "The supplication traditionally offered when a complete reading is sealed.")
    ]

    static let glossary: [QPTerm] = glossaryA + glossaryB + glossaryC

    private static let badgesA: [QPBadge] = [
        QPBadge(id: "qb-first", title: "First Page", detail: "Log your first page of reading."),
        QPBadge(id: "qb-juz", title: "First Part", detail: "Read your first full juz worth of pages."),
        QPBadge(id: "qb-amma", title: "Juz Amma", detail: "Carry a khatm into the thirtieth part."),
        QPBadge(id: "qb-half", title: "The Halfway Ridge", detail: "Pass page 302 — half the mushaf."),
        QPBadge(id: "qb-khatm", title: "Sealed", detail: "Complete a full khatm."),
        QPBadge(id: "qb-threekhatms", title: "Three Seals", detail: "Complete three khatms."),
        QPBadge(id: "qb-tenday", title: "Ten in a Day", detail: "Read ten pages in a single day."),
        QPBadge(id: "qb-twentyday", title: "A Juz in a Day", detail: "Read twenty pages in a single day."),
        QPBadge(id: "qb-week", title: "Seven Days Running", detail: "Keep a 7-day reading streak.")
    ]

    private static let badgesB: [QPBadge] = [
        QPBadge(id: "qb-month", title: "A Month Unbroken", detail: "Keep a 30-day reading streak."),
        QPBadge(id: "qb-days30", title: "Thirty Sittings", detail: "Read on thirty different days."),
        QPBadge(id: "qb-days100", title: "A Hundred Sittings", detail: "Read on a hundred different days."),
        QPBadge(id: "qb-pages604", title: "Six Hundred Four", detail: "Read 604 pages in all — a mushaf's worth."),
        QPBadge(id: "qb-pages3020", title: "Five Books Deep", detail: "Read 3,020 pages in all."),
        QPBadge(id: "qb-planner", title: "The Planner", detail: "Start a khatm with a finish date."),
        QPBadge(id: "qb-quiz", title: "Sound Knowledge", detail: "Score a perfect quiz round."),
        QPBadge(id: "qb-tenquiz", title: "Steady Student", detail: "Finish ten quiz rounds."),
        QPBadge(id: "qb-guides", title: "Well Read", detail: "Finish every guide in the Learn tab.")
    ]

    static let badges: [QPBadge] = badgesA + badgesB
}
