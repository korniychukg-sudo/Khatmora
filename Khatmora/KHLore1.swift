...
enum KHLore {
    private static let guidesA: [KHGuide] = [
        KHGuide(
            id: "qg-mushaf",
            ...
            sections: [
                ...
                KHGuideSection(
                    ...
                    body: "Khatmora uses the standard counts of the Madani layout: 604 pages, 114 surahs, 30 parts, and 6,236 verses. Tap any page in the Mushaf tab and the app knows which juz it belongs to and which surah is flowing across it."
                ),
                KHGuideSection(
    ...
    private static let guidesB: [KHGuide] = [
        KHGuide(
            id: "qg-ramadan",
    ...
    static let guides: [KHGuide] = guidesA + guidesB + guidesC + guidesD
}
